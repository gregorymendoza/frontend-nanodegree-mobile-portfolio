...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "src/images/pizza.png";
...
function updatePositions() {
  ...
  // As a good JavaScript practice, I assigned the operations to a variable before the loops to reduce calculations.
  topScroll = document.body.scrollTop / 1250;

  // Created an array for the 0-5 possible numbers of the fixed values given by the modulo (%) operator.
  phaseArray = [
                Math.sin(topScroll + 0),
                Math.sin(topScroll + 1),
                Math.sin(topScroll + 2),
                Math.sin(topScroll + 3),
                Math.sin(topScroll + 4),
                Math.sin(topScroll + 5),
               ];
