...
Alternatively, you can clone the repository with Git or download the ZIP file and extract it to your local machine, then do the following Some useful tips to help you get started:
